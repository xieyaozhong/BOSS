...
「音樂」能力另有三樂器資料庫：小提琴、吉他與鋼琴各自包含樂譜、樂理與作品區，未提供真實內容前保留清楚空狀態。
...
- 整理小提琴、吉他與鋼琴的合法樂譜來源、本人樂理筆記與可公開作品
...
音樂資料集中在 [`site/data/music-library.json`](site/data/music-library.json)。三種樂器及所有項目都必須是本人確認內容；每個項目需要明確標示本人原創、已獲授權、公版版本或僅連結外部來源。原曲進入公版不代表現代編訂譜也能自由重製，商業樂譜、完整歌詞、未授權音訊與本機二進位檔不會放入網站；內容只使用通過檢查的公開 HTTPS 連結，且授權來源與條款會在卡片上顯示。
